...
BLOCKING_PACKAGES = MASKED + [
    ...
    Package('sys-devel/gcc',
            use_flags='-* cet',
            extra_use_flags='jit graphite pch',
            blocking=True,
            keywords={'ram-hog'}),
...
PACKAGES = [
    ...
    Package('app-crypt/hashcat-utils'),
    ...
    Package('app-emulation/qemu',
            ...
            extra_use_flags='\n'.join([
                '\n'
                'app-emulation/qemu QEMU_USER_TARGETS: aarch64 x86_64',
                'app-emulation/qemu QEMU_SOFTMMU_TARGETS: aarch x86_64 i386'])),
